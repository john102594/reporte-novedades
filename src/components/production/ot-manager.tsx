  ...
  if (!activeOrder) {
    return (
      <Card className="p-6 bg-card/60 backdrop-blur border-border max-w-md mx-auto mt-10">
        <h2 className="text-2xl font-bold mb-4 bg-gradient-to-r from-purple-400 via-primary to-purple-600 dark:to-purple-400 bg-clip-text text-transparent">Start Production</h2>
